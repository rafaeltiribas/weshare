...
const useAPI = <T>(endpoint: string) => {
    ...
    const getPage = (config: AxiosRequestConfig) => axiosInstance
        .get<PageResult<T>>(endpoint + "/page", config)
        .then((response) => response.data)
        .catch((error) => {
            if (error.response) {
                throw new CustomError(
    ...
    const signup = (obj: T) => axiosInstance
        .post<T>(endpoint, obj)
        .then((response) => response.data)
        .catch((error) => {
    ...
    const update = (obj: T) => axiosInstance
        .put<T>(endpoint, obj)
        .then((response) => response.data)
        .catch((error) => {
            console.log(error.response);
    ...
    return {get, remove, getPage, signup, update}    
}
